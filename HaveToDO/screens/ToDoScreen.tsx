...
mutation createToDo($content:String!, $ProyectosId: ID!) {
  createToDo(content: $content, ProyectosId: $ProyectosId) {
    id
		content
    isCompleted
    Proyectos {
...
export default function ToDoScreen() {
  ...
  useEffect(() => {
    if (data) {
      setProject(data.listarProyectos);
      setTitle(data.listarProyectos.title);
    }
  }, [data]);
